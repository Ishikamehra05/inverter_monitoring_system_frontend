...
const DeviceOverview = ({
  ...
  const handleBack = () => {
    ...
    router.replace(`/monitor/plants/plant-detail?plantId=${plantId}`);
  };
  ...
  return (
    <div className={`bg-white p-2 md:p-6 rounded-lg ${className}`}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-6 text-md text-gray-500 mt-6">
        ...
        <span className="flex flex-col items-center gap-2 md:gap-4 whitespace-nowrap">
          <p className="font-semibold text-sm sm:text-md">E-Today:</p>
          <p className="text-black text-lg sm:text-2xl font-semibold">
            {todayEnergy} kWh
          </p>
        </span>
        ...
        <span className="flex flex-col items-center gap-2 md:gap-4 whitespace-nowrap">
          <p className="font-semibold text-sm sm:text-md">E-Total:</p>
          <p className="text-black text-lg sm:text-2xl font-semibold">
            {totalEnergy} kWh
          </p>
        </span>
        ...
        <span className="flex flex-col items-center gap-2 md:gap-4 whitespace-nowrap">
          <p className="font-semibold text-sm sm:text-md">H-Total:</p>
          <p className="text-black text-lg sm:text-2xl font-semibold">
            {hours} Hrs
          </p>
        </span>
        ...
        <span className="flex flex-col items-center gap-2 md:gap-4 whitespace-nowrap">
          <p className="font-semibold text-sm sm:text-md">Last Update:</p>
